...
- Lưu danh sách nguyện vọng bằng `localStorage`, đổi thứ tự NV, sửa phương thức/ghi chú, in danh sách và xuất CSV.
- Chạy offline, không cần backend, không cần thư viện ngoài.

## Chức năng quản lý nguyện vọng

- Bấm **Thêm NV** ở bảng tra cứu để lưu ngành vào danh sách.
- Tab **Danh sách nguyện vọng** cho phép đổi thứ tự bằng nút ↑/↓, đưa ngành lên NV1, sửa phương thức, sửa ghi chú và xóa NV.
- Danh sách được lưu tự động trong trình duyệt bằng `localStorage`.
- Có thể **in danh sách nguyện vọng** hoặc **xuất CSV** để nộp/lưu hồ sơ.
